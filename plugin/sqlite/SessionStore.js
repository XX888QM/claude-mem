...
"use strict";var G=Object.defineProperty;var De=Object.getOwnPropertyDescriptor;var Ue=Object.getOwnPropertyNames;var we=Object.prototype.hasOwnProperty;var Me=(i,e)=>{for(var s in e)G(i,s,{get:e[s],enumerable:!0})},xe=(i,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ue(e))!we.call(i,n)&&n!==s&&G(i,n,{get:()=>e[n],enumerable:!(t=De(e,n))||t.enumerable});return i};var Fe=i=>xe(G({},"__esModule",{value:!0}),i);var cs={};Me(cs,{SessionStore:()=>ee,TELEGRAM_WRAPUP_CLAIM_STALE_AFTER_MS:()=>Ce,rollupObservationFileLists:()=>ve});module.exports=Fe(cs);var Z=require("bun:sqlite"),ye=require("crypto");var b=require("path"),j=require("os"),U=require("fs"),ne=require("url");var ke=null;function Xe(i){return(ke??process.stderr.write.bind(process.stderr))(i)}function F(i){Xe(i)}var Ts=process.platform==="win32";function $e(i){return i.replace(/^\uFEFF/,"")}function k(i){return JSON.parse($e(i))}var se=require("os"),te=require("path");function X(i,e=process.platform,s=(0,se.homedir)()){return typeof i!="string"||i.length===0?i:i==="~"?s:i.startsWith("~/")||e==="win32"&&i.startsWith("~\\")?(0,te.join)(s,i.slice(2)):i}function Pe(){return typeof __CM_DIRNAME__<"u"?__CM_DIRNAME__:(0,b.dirname)((0,ne.fileURLToPath)(__IMPORT_META_URL__))}var hs=Pe();function Be(){if(process.env.CLAUDE_MEM_DATA_DIR)return X(process.env.CLAUDE_MEM_DATA_DIR);let i=(0,b.join)((0,j.homedir)(),".claude-mem"),e=(0,b.join)(i,"settings.json");try{if((0,U.existsSync)(e)){let s=k((0,U.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return X(t.CLAUDE_MEM_DATA_DIR)}}catch{}return i}var I=Be(),Ge=(0,b.join)((0,j.homedir)(),".claude"),je=process.env.CLAUDE_CONFIG_DIR||Ge,Is=(0,b.join)(je,"plugins","marketplaces","thedotmack"),He=(0,b.join)(I,"logs"),Rs=(0,b.join)(I,"settings.json"),re="claude-mem.db";var oe=(0,b.join)(I,re),We=(0,b.join)(I,"observer-sessions"),H=(0,b.basename)(We);function ie(i){(0,U.mkdirSync)(i,{recursive:!0})}var W={dataDir:()=>I,workerPid:()=>(0,b.join)(I,"worker.pid"),serverPid:()=>(0,b.join)(I,".server-beta.pid"),serverPort:()=>(0,b.join)(I,".server-beta.port"),serverRuntime:()=>(0,b.join)(I,".server-beta.runtime.json"),settings:()=>(0,b.join)(I,"settings.json"),database:()=>(0,b.join)(I,re),chroma:()=>(0,b.join)(I,"chroma"),combinedCerts:()=>(0,b.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,b.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,b.join)(I,"transcript-watch-state.json"),corpora:()=>(0,b.join)(I,"corpora"),supervisorRegistry:()=>(0,b.join)(I,"supervisor.json"),envFile:()=>(0,b.join)(I,".env"),logsDir:()=>He};var y=require("fs"),K=require("path");var V=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(V||{}),qe=/^claude-mem-(\d{4}-\d{2}-\d{2})\.log$/,Ve=14,Ye=1440*60*1e3;function Ke(i,e=Date.now(),s=Ve){if(!(0,y.existsSync)(i))return 0;let t=new Date(e-s*Ye).toISOString().slice(0,10),n=0;try{for(let o of(0,y.readdirSync)(i)){let r=qe.exec(o);if(!(!r||r[1]>=t))try{(0,y.unlinkSync)((0,K.join)(i,o)),n+=1}catch{}}}catch{return n}return n}var q=null,Y=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;logFileDate=null;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){let e=new Date().toISOString().split("T")[0];if(!(this.logFileInitialized&&this.logFileDate===e)){this.logFileInitialized=!0,this.logFileDate=e;try{let s=W.logsDir();(0,y.existsSync)(s)||(0,y.mkdirSync)(s,{recursive:!0}),Ke(s),this.logFilePath=(0,K.join)(s,`claude-mem-${e}.log`),this.logFileInitialized=!0,this.logFileDate=e}catch(s){console.error("[LOGGER] Failed to initialize log file:",s instanceof Error?s.message:String(s)),this.logFilePath=null,this.logFileInitialized=!0,this.logFileDate=e}}}getLevel(){if(this.level===null)try{let e=W.settings();if((0,y.existsSync)(e)){let s=(0,y.readFileSync)(e,"utf-8"),n=(k(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=V[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{l=" "+this.formatData(o)}else l=" "+this.formatData(o);let p="";if(n){let{sessionId:R,memorySessionId:A,correlationId:N,...m}=n;Object.keys(m).length>0&&(p=` {${Object.entries(m).map(([f,v])=>`${f}=${v}`).join(", ")}}`)}let T=`[${r}] [${a}] [${d}] ${u}${t}${p}${l}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,T+`
`,"utf8")}catch(R){let A=R instanceof Error?R:new Error(String(R));F(`[LOGGER] Failed to write to log file: ${A.message}
${A.stack??""}
`)}else F(T+`
`)}debug(e,s,t,n){this.log(0,e,s,t,n)}info(e,s,t,n){this.log(1,e,s,t,n)}warn(e,s,t,n){this.log(2,e,s,t,n)}setErrorSink(e){q=e}error(e,s,t,n){this.log(3,e,s,t,n),this.routeErrorToSink(s,t,n)}routeErrorToSink(e,s,t){try{if(!q||!(t instanceof Error))return;q(t)}catch{}}dataIn(e,s,t,n){this.info(e,`\u2192 ${s}`,t,n)}dataOut(e,s,t,n){this.info(e,`\u2190 ${s}`,t,n)}success(e,s,t,n){this.info(e,`\u2713 ${s}`,t,n)}failure(e,s,t,n){this.error(e,`\u2717 ${s}`,t,n)}},_=new Y;var ae=require("crypto");function de(i,e,s){return(0,ae.createHash)("sha256").update([i||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var le=require("crypto");var c="claude";function Je(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function g(i){if(!i)return c;let e=Je(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e.includes("grok")?"grok":e:c}function _e(i){let e=["claude","codex","grok","cursor"];return[...i].sort((s,t)=>{let n=e.indexOf(s),o=e.indexOf(t);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:s.localeCompare(t)})}var Qe=64*1024,ze=new Set(["search","timeline","get_observations","get_tool_uses","session_start_context","observation_search"]);function Ze(i){if(!i)return!1;if(i.startsWith("memory_"))return!0;if(!i.startsWith("mcp__"))return!1;let e=i.split("__");if(e.length<3)return!1;let s=e[1].toLowerCase(),t=e.slice(2).join("__");return(s.includes("claude-mem")||s.includes("claude_mem")||s.includes("mcp-search")||s.includes("cmem"))&&ze.has(t)}function ue(i,e=Qe){let s=Buffer.byteLength(i,"utf8");if(s<=e)return i;let t=Buffer.from(i,"utf8"),n=e;for(;n>0&&(t[n]&192)===128;)n--;return`${t.subarray(0,n).toString("utf8")}\u2026[truncated: ${s} bytes]`}function es(i,e,s){return(0,le.createHash)("sha256").update([i||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}function ce(i){i.run(`
  ...
  `).get()!=null}function w(i,e,s){try{i.run(e)}catch(t){let n=t instanceof Error?t:new Error(String(t));throw _.warn("DB",`Failed to apply SQLite pragma ${s}`,{sql:e},n),t}}function Re(i,e={}){let{enableWal:s=!0,enableIncrementalAutoVacuum:t=!0}=e;w(i,`PRAGMA busy_timeout = ${rs}`,"busy_timeout"),w(i,"PRAGMA foreign_keys = ON","foreign_keys"),w(i,"PRAGMA synchronous = NORMAL","synchronous"),w(i,`PRAGMA journal_size_limit = ${os}`,"journal_size_limit"),t&&!is(i)&&w(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),s&&w(i,"PRAGMA journal_mode = WAL","journal_mode")}var Oe=4096;var as=new Set(["set_title","set_prompt_session","remap_project"]),ds=/^(?:0|[1-9][0-9]*)$/,Ae=18446744073709551615n;function L(i){throw _.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function B(i,e={}){return typeof i!="string"||!ds.test(i)?L("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>Ae&&L("decimal value exceeds uint64"),e.positive&&i==="0"&&L("decimal value must be positive"),i)}function Q(i){let e=B(i);return BigInt(e)===Ae&&L("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function _s(i){(i===null||typeof i!="object"||Array.isArray(i))&&L("mutation must be an object");let e=i;if((typeof e.op!="string"||!as.has(e.op))&&L("unsupported mutation op"),e.op==="set_title"){let o=M(e,["fields","op","target"],"set_title"),r=P(o.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");r.memory_session_id===void 0&&r.content_session_id===void 0&&L("set_title target requires a session identifier");for(let d of["memory_session_id","content_session_id","platform_source"])r[d]!==void 0&&D(r[d],d);let a=M(o.fields,["custom_title"],"set_title.fields");D(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let o=M(e,["fields","op","target"],"set_prompt_session"),r=M(o.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");us(r.origin_device_id),B(r.origin_local_id);let a=P(o.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");D(a.memory_session_id,"memory_session_id");for(let d of["content_session_id","platform_source","project"])a[d]!==void 0&&D(a[d],d);return}let s=M(e,["fields","op","where"],"remap_project"),t=P(s.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");t.project!==void 0&&D(t.project,"project"),t.memory_session_id!==void 0&&D(t.memory_session_id,"memory_session_id"),t.merged_into_project_is_null!==void 0&&t.merged_into_project_is_null!==!0&&L("merged_into_project_is_null may only be true"),Object.keys(t).length===0&&L("remap_project where is empty");let n=P(s.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&D(n.project,"project"),n.merged_into_project!==void 0&&D(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&L("remap_project fields are empty")}function z(i){_s(i)}function us(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?L("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function D(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>Oe?L(`${e} must be a non-blank string of at most ${Oe} UTF-8 bytes`):i}function M(i,e,s){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${s} must be an object`);let t=i,n=Object.keys(t).sort(),o=[...e].sort();return(n.length!==o.length||n.some((r,a)=>r!==o[a]))&&L(`${s} must contain exactly: ${o.join(", ")}`),t}function P(i,e,s){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${s} must be an object`);let t=i,n=new Set(e),o=Object.keys(t).find(r=>!n.has(r));return o&&L(`${s} contains unknown field ${o}`),t}var Ce=5*6e4,Le=!1;function ls(i){return typeof i.iterate=="function"?i.iterate():(Le||(Le=!0,_.warn("DB","bun:sqlite lacks Statement.iterate(); falling back to .all()",{bunVersion:typeof Bun<"u"?Bun.version:"unknown",requiredBunVersion:">=1.1.31",impact:"migration rows are materialized in memory; upgrade Bun to restore streaming"})),i.all())}function ve(i){let e=[],s=[],t=new Set,n=new Set;for(let o of i){for(let r of o.files_read??[])!r||t.has(r)||(t.add(r),e.push(r));for(let r of o.files_modified??[])!r||n.has(r)||(n.add(r),s.push(r))}return{files_read:e,files_edited:s}}var ee=class{db;syncOpsEnabled;constructor(e=oe,s={}){this.syncOpsEnabled=s.syncOpsEnabled??!0,e instanceof Z.Database?this.db=e:(e!==":memory:"&&ie(I),this.db=new Z.Database(e)),Re(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags(),this.ensureSDKSessionsObservedColumns(),this.ensureToolUsesTable(),this.ensureTelegramWrapupsTable()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===s.length&&o.every((r,a)=>r===s[a])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let n=t?g(t):void 0;return n?this.db.prepare(`
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);return n.memory_session_id===null?(this.db.prepare(`
      ...
      `).run(t,e),n.memory_session_id??s}getAllProjects(e){let s=e?g(e):void 0,t=`
    ...
    `).all(H),s=[],t=new Set,n={};for(let r of e){let a=g(r.platform_source);n[a]||(n[a]=[]),n[a].includes(r.project)||n[a].push(r.project),t.has(r.project)||(t.add(r.project),s.push(r.project))}let o=_e(Object.keys(n));return{projects:s,sources:o,projectsBySource:Object.fromEntries(o.map(r=>[r,n[r]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),n=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,s,t,n){return fe(this.db,e,$(s),t,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let n=[e],o="";return t&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`,n.push(g(t))),n.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,g(s))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}upsertToolUse(e){return pe(this.db,e)}linkToolUsesToObservation(e){return me(this.db,e)}getToolUsesByIds(e,s={}){return Te(this.db,e,s)}queryToolUses(e={}){return be(this.db,e)}countToolUses(e={}){return ge(this.db,e)}getObservationsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:o,platformSource:r,type:a,concepts:d,files:u}=s,l=t==="relevance",p=l?"":`ORDER BY o.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,T=n&&!l?`LIMIT ${n}`:"",R=e.map(()=>"?").join(","),A=[...e],N=[];if(o&&(N.push("(o.project = ? OR o.merged_into_project = ?)"),A.push(o,o)),r&&(N.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),A.push(g(r))),a)if(Array.isArray(a)){let h=a.map(()=>"?").join(",");N.push(`o.type IN (${h})`),A.push(...a)}else N.push("o.type = ?"),A.push(a);if(d){let h=Array.isArray(d)?d:[d],S=h.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");A.push(...h),N.push(`(${S.join(" OR ")})`)}if(u){let h=Array.isArray(u)?u:[u],S=h.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");h.forEach(O=>{A.push(`%${O}%`,`%${O}%`)}),N.push(`(${S.join(" OR ")})`)}let m=N.length>0?`WHERE o.id IN (${R}) AND ${N.join(" AND ")}`:`WHERE o.id IN (${R})`,f=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${m}
      ${p}
      ${T}
    `).all(...A);if(!l)return f;let v=new Map(f.map(h=>[h.id,h])),E=e.map(h=>v.get(h)).filter(h=>!!h);return n?E.slice(0,n):E}getSummaryForSession(e,s){let t=[e],n="";return s&&(n=`
        AND EXISTS (
          SELECT 1
      ...
      ORDER BY created_at_epoch DESC
      LIMIT 1
    `).get(...t)||null}getSDKSessionId(e,s){let t=g(s);return this.db.prepare(`
      SELECT id
      FROM sdk_sessions
      WHERE COALESCE(NULLIF(platform_source, ''), ?) = ?
        AND content_session_id = ?
    `).get(c,t,e)?.id??null}hasSDKSession(e,s){return this.getSDKSessionId(e,s)!=null}getSessionById(e){return this.db.prepare(`
    ...
    `).get(e)||null}findSessionDbIdByContentSessionId(e,s){return this.db.prepare(`
      ...
      WHERE COALESCE(NULLIF(platform_source, ''), ?) = ?
        AND content_session_id = ?
      LIMIT 1
    `).get(c,g(s),e)?.id??null}claimTelegramWrapup({platformSource:e,contentSessionId:s,project:t,routeKey:n,summaryCreatedAtEpoch:o}){let r=Date.now();return this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, 'claimed', ?, NULL)
    `).run(g(e),s,t,n,o,r).changes===1?!0:this.db.prepare(`
    ...
    `).run(o,r,g(e),s,t,n,r-Ce).changes===1}markTelegramWrapupSent({platformSource:e,contentSessionId:s,project:t,routeKey:n}){this.db.prepare(`
      UPDATE telegram_wrapups
    ...
    `).get(e).count}getLatestPromptTextFromUserPrompts(e,s){let t=this.resolvePromptSessionDbId(e,s),n=t!==null?"session_db_id = ?":"content_session_id = ?",o=t!==null?t:e;return this.db.prepare(`
      ...
      LIMIT 1
    `).get(o)?.prompt_text??null}createSDKSession(e,s,t,n,o){let r=new Date,a=r.getTime(),d=o?g(o):c,u=$(t);n&&this.validateSetTitleMutation(e,d,n);let l=this.db.prepare(`
    ...
    `).run(d,e,s,a,o.toISOString(),r).lastInsertRowid}getUserPrompt(e,s,t){let n=this.resolvePromptSessionDbId(e,t);return n!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,n,o=0,r,a){if(!t.title||t.title.trim()==="")throw new Error("storeObservation requires a non-empty title");let d=this.storeObservations(e,s,[t],null,n,o,r,a);return{id:d.observationIds[0],createdAtEpoch:d.createdAtEpoch}}storeSummary(e,s,t,n,o=0,r){let a=r??Date.now(),d=new Date(a).toISOString();return{id:this.upsertSummaryRow(e,s,t,n,o,d,a),createdAtEpoch:a}}upsertSummaryRow(e,s,t,n,o,r,a){let d=n!==void 0?this.db.prepare(`
          SELECT id FROM session_summaries
          WHERE memory_session_id = ? AND prompt_number = ?
          ORDER BY created_at_epoch DESC, id DESC LIMIT 1
        `).get(e,n):t.request?this.db.prepare(`
            SELECT id FROM session_summaries
            WHERE memory_session_id = ? AND request = ?
            ORDER BY created_at_epoch DESC, id DESC LIMIT 1
          `).get(e,t.request):null;if(d)return this.db.prepare(`
        UPDATE session_summaries SET
          project = ?, request = ?, investigated = ?, learned = ?, completed = ?,
          next_steps = ?, notes = ?, prompt_number = ?, discovery_tokens = ?,
          created_at = ?, created_at_epoch = ?
        WHERE id = ?
      `).run(s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,n??null,o,r,a,d.id),d.id;let u=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, files_read, files_edited, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,JSON.stringify(t.files_read??[]),JSON.stringify(t.files_edited??[]),t.notes,n??null,o,r,a);return Number(u.lastInsertRowid)}storeObservations(e,s,t,n,o,r=0,a,d){let u=a??Date.now(),l=new Date(u).toISOString();return this.db.transaction(()=>{let T=[],R=this.db.prepare(`
        ...
        RETURNING id
      `),A=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let m of t){if(!m.title||m.title.trim()===""){_.debug("DB","Skipping observation with empty title");continue}let C=de(e,m.title,m.narrative),f=R.get(e,s,m.type,m.title,m.subtitle,JSON.stringify(m.facts),m.narrative,JSON.stringify(m.concepts),JSON.stringify(m.files_read),JSON.stringify(m.files_modified),o||null,r,m.agent_type??null,m.agent_id??null,C,l,u,d||null,m.metadata??null);if(f){T.push(f.id);continue}let v=A.get(e,C);if(!v)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${C}`);T.push(v.id)}let N=null;if(n){let m=ve(t);N=this.upsertSummaryRow(e,s,{...n,files_read:n.files_read??m.files_read,files_edited:n.files_edited??m.files_edited},o,r,l,u)}return{observationIds:T,summaryId:N,createdAtEpoch:u}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:o,platformSource:r}=s,a=t==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,u=n&&!a?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),p=[...e],T=[];o&&(T.push("(ss.project = ? OR ss.merged_into_project = ?)"),p.push(o,o)),r&&(T.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),p.push(g(r)));let R=T.length>0?`AND ${T.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT ss.*
      ...
      ${d}
      ${u}
    `).all(...p);if(!a)return N;let m=new Map(N.map(f=>[f.id,f])),C=e.map(f=>m.get(f)).filter(f=>!!f);return n?C.slice(0,n):C}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:o,platformSource:r}=s,a=t==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,u=n&&!a?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),p=[...e],T=[];o&&(T.push("s.project = ?"),p.push(o)),r&&(T.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),p.push(g(r)));let R=T.length>0?`AND ${T.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${u}
    `).all(...p);if(!a)return N;let m=new Map(N.map(f=>[f.id,f])),C=e.map(f=>m.get(f)).filter(f=>!!f);return n?C.slice(0,n):C}getTimelineAroundTimestamp(e,s=10,t=10,n,o){return this.getTimelineAroundObservation(null,e,s,t,n,o)}getTimelineAroundObservation(e,s,t=10,n=10,o,r){let a=r?g(r):void 0,d=(E,h,S=!1)=>{let O=[],x=[];return o&&(S?(O.push(`(${E}.project = ? OR ${E}.merged_into_project = ?)`),x.push(o,o)):(O.push(`${E}.project = ?`),x.push(o))),a&&(O.push(`COALESCE(NULLIF(${h}.platform_source, ''), '${c}') = ?`),x.push(a)),{clause:O.length>0?`AND ${O.join(" AND ")}`:"",params:x}},u=d("o","src",!0),l=d("ss","src",!0),p=d("s","s"),T,R;if(e!==null){let E=`
      ...
      `,h=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let S=this.db.prepare(E).all(e,...u.params,t+1),O=this.db.prepare(h).all(e,...u.params,n+1);if(S.length===0&&O.length===0)return{observations:[],sessions:[],prompts:[]};T=S.length>0?S[S.length-1].created_at_epoch:s,R=O.length>0?O[O.length-1].created_at_epoch:s}catch(S){return S instanceof Error?_.error("DB","Error getting boundary observations",{project:o},S):_.error("DB","Error getting boundary observations with non-Error",{},new Error(String(S))),{observations:[],sessions:[],prompts:[]}}}else{let E=`
      ...
      `,h=`
        ...
        LIMIT ?
      `;try{let S=this.db.prepare(E).all(s,...u.params,t),O=this.db.prepare(h).all(s,...u.params,n+1);if(S.length===0&&O.length===0)return{observations:[],sessions:[],prompts:[]};T=S.length>0?S[S.length-1].created_at_epoch:s,R=O.length>0?O[O.length-1].created_at_epoch:s}catch(S){return S instanceof Error?_.error("DB","Error getting boundary timestamps",{project:o},S):_.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(S))),{observations:[],sessions:[],prompts:[]}}}let A=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
