...
`)}debug(e,s,t,n){this.log(0,e,s,t,n)}info(e,s,t,n){this.log(1,e,s,t,n)}warn(e,s,t,n){this.log(2,e,s,t,n)}setErrorSink(e){q=e}error(e,s,t,n){this.log(3,e,s,t,n),this.routeErrorToSink(s,t,n)}routeErrorToSink(e,s,t){try{if(!q||!(t instanceof Error))return;q(t)}catch{}}dataIn(e,s,t,n){this.info(e,`\u2192 ${s}`,t,n)}dataOut(e,s,t,n){this.info(e,`\u2190 ${s}`,t,n)}success(e,s,t,n){this.info(e,`\u2713 ${s}`,t,n)}failure(e,s,t,n){this.error(e,`\u2717 ${s}`,t,n)}},_=new Y;var ie=require("crypto");function ae(i,e,s){return(0,ie.createHash)("sha256").update([i||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function Fe(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function L(i){if(!i)return p;let e=Fe(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e.includes("grok")?"grok":e:p}function de(i){let e=["claude","codex","grok","cursor"];return[...i].sort((s,t)=>{let n=e.indexOf(s),r=e.indexOf(t);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:s.localeCompare(t)})}function _e(i,e,s,t,n){let r=Date.now()-t,o=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return i.prepare(`
    ...
    LIMIT 1
  `).get(a,s,r)??void 0}var pe=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],ce=new RegExp(`<(${pe.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g");var ue=100;function ke(i){let e=Object.fromEntries(pe.map(n=>[n,0]));ce.lastIndex=0;let s=0,t=i.replace(ce,(n,r)=>(e[r]=(e[r]??0)+1,s+=1,""));return s>ue&&_.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:ue,contentLength:i.length}),{stripped:t.trim(),counts:e}}function le(i){return ke(i).stripped}var Xe=["task-notification"],bs=new RegExp(`^\\s*<(${Xe.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),fs=256*1024;var J=4e3;function P(i){let e=i.trim(),t=le(i).trim()||e;return t.length<=J?t:(_.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:J}),`${t.slice(0,J-1)}\u2026`)}var Pe=require("bun:sqlite");var Be=5e3,Ge=4194304;function $e(i){return i.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
  ...
  `).get()!=null}function w(i,e,s){try{i.run(e)}catch(t){let n=t instanceof Error?t:new Error(String(t));throw _.warn("DB",`Failed to apply SQLite pragma ${s}`,{sql:e},n),t}}function me(i,e={}){let{enableWal:s=!0,enableIncrementalAutoVacuum:t=!0}=e;w(i,`PRAGMA busy_timeout = ${Be}`,"busy_timeout"),w(i,"PRAGMA foreign_keys = ON","foreign_keys"),w(i,"PRAGMA synchronous = NORMAL","synchronous"),w(i,`PRAGMA journal_size_limit = ${Ge}`,"journal_size_limit"),t&&!$e(i)&&w(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),s&&w(i,"PRAGMA journal_mode = WAL","journal_mode")}var Ee=4096;var je=new Set(["set_title","set_prompt_session","remap_project"]),He=/^(?:0|[1-9][0-9]*)$/,Te=18446744073709551615n;function y(i){throw _.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function G(i,e={}){return typeof i!="string"||!He.test(i)?y("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>Te&&y("decimal value exceeds uint64"),e.positive&&i==="0"&&y("decimal value must be positive"),i)}function Q(i){let e=G(i);return BigInt(e)===Te&&y("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function We(i){(i===null||typeof i!="object"||Array.isArray(i))&&y("mutation must be an object");let e=i;if((typeof e.op!="string"||!je.has(e.op))&&y("unsupported mutation op"),e.op==="set_title"){let r=M(e,["fields","op","target"],"set_title"),o=B(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&y("set_title target requires a session identifier");for(let d of["memory_session_id","content_session_id","platform_source"])o[d]!==void 0&&D(o[d],d);let a=M(r.fields,["custom_title"],"set_title.fields");D(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=M(e,["fields","op","target"],"set_prompt_session"),o=M(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");qe(o.origin_device_id),G(o.origin_local_id);let a=B(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");D(a.memory_session_id,"memory_session_id");for(let d of["content_session_id","platform_source","project"])a[d]!==void 0&&D(a[d],d);return}let s=M(e,["fields","op","where"],"remap_project"),t=B(s.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");t.project!==void 0&&D(t.project,"project"),t.memory_session_id!==void 0&&D(t.memory_session_id,"memory_session_id"),t.merged_into_project_is_null!==void 0&&t.merged_into_project_is_null!==!0&&y("merged_into_project_is_null may only be true"),Object.keys(t).length===0&&y("remap_project where is empty");let n=B(s.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&D(n.project,"project"),n.merged_into_project!==void 0&&D(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&y("remap_project fields are empty")}function z(i){We(i)}function qe(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?y("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function D(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>Ee?y(`${e} must be a non-blank string of at most ${Ee} UTF-8 bytes`):i}function M(i,e,s){if(i===null||typeof i!="object"||Array.isArray(i))return y(`${s} must be an object`);let t=i,n=Object.keys(t).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&y(`${s} must contain exactly: ${r.join(", ")}`),t}function B(i,e,s){if(i===null||typeof i!="object"||Array.isArray(i))return y(`${s} must be an object`);let t=i,n=new Set(e),r=Object.keys(t).find(o=>!n.has(o));return r&&y(`${s} contains unknown field ${r}`),t}var ee=class{db;constructor(e=re){e instanceof Z.Database?this.db=e:(e!==":memory:"&&oe(I),this.db=new Z.Database(e)),me(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let r=this.getIndexColumns(n.name);return r.length===s.length&&r.every((o,a)=>o===s[a])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let n=t?L(t):void 0;return n?this.db.prepare(`
    ...
    `).get(e,L(s))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o,type:a,concepts:d,files:c}=s,u=t==="relevance",l=u?"":`ORDER BY o.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,m=n&&!u?`LIMIT ${n}`:"",N=e.map(()=>"?").join(","),O=[...e],S=[];if(r&&(S.push("(o.project = ? OR o.merged_into_project = ?)"),O.push(r,r)),o&&(S.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),O.push(L(o))),a)if(Array.isArray(a)){let R=a.map(()=>"?").join(",");S.push(`o.type IN (${R})`),O.push(...a)}else S.push("o.type = ?"),O.push(a);if(d){let R=Array.isArray(d)?d:[d],g=R.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");O.push(...R),S.push(`(${g.join(" OR ")})`)}if(c){let R=Array.isArray(c)?c:[c],g=R.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");R.forEach(A=>{O.push(`%${A}%`,`%${A}%`)}),S.push(`(${g.join(" OR ")})`)}let T=S.length>0?`WHERE o.id IN (${N}) AND ${S.join(" AND ")}`:`WHERE o.id IN (${N})`,f=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${T}
      ${l}
      ${m}
    `).all(...O);if(!u)return f;let C=new Map(f.map(R=>[R.id,R])),E=e.map(R=>C.get(R)).filter(R=>!!R);return n?E.slice(0,n):E}getSummaryForSession(e,s){let t=[e],n="";return s&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,s,t,n,r){let o=new Date,a=o.getTime(),d=r?L(r):p,c=P(t);n&&this.validateSetTitleMutation(e,d,n);let u=this.db.prepare(`
    ...
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,n,r=0,o,a){let d=this.storeObservations(e,s,[t],null,n,r,o,a);return{id:d.observationIds[0],createdAtEpoch:d.createdAtEpoch}}storeSummary(e,s,t,n,r=0,o){let a=o??Date.now(),d=new Date(a).toISOString();return{id:this.upsertSummaryRow(e,s,t,n,r,d,a),createdAtEpoch:a}}upsertSummaryRow(e,s,t,n,r,o,a){let d=n!==void 0?this.db.prepare(`
        ...
        UPDATE session_summaries SET
          ...
          created_at = ?, created_at_epoch = ?
        WHERE id = ?
      `).run(s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,n??null,r,o,a,d.id),d.id;let c=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,n??null,r,o,a);return Number(c.lastInsertRowid)}storeObservations(e,s,t,n,r,o=0,a,d){let c=a??Date.now(),u=new Date(c).toISOString();return this.db.transaction(()=>{let m=[],N=this.db.prepare(`
        ...
        RETURNING id
      `),O=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let T of t){let h=ae(e,T.title,T.narrative),f=N.get(e,s,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),r||null,o,T.agent_type??null,T.agent_id??null,h,u,c,d||null,T.metadata??null);if(f){m.push(f.id);continue}let C=O.get(e,h);if(!C)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${h}`);m.push(C.id)}let S=null;return n&&(S=this.upsertSummaryRow(e,s,n,r,o,u,c)),{observationIds:m,summaryId:S,createdAtEpoch:c}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o}=s,a=t==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],m=[];r&&(m.push("(ss.project = ? OR ss.merged_into_project = ?)"),l.push(r,r)),o&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(L(o)));let N=m.length>0?`AND ${m.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT ss.*
      ...
      ${d}
      ${c}
    `).all(...l);if(!a)return S;let T=new Map(S.map(f=>[f.id,f])),h=e.map(f=>T.get(f)).filter(f=>!!f);return n?h.slice(0,n):h}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o}=s,a=t==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],m=[];r&&(m.push("s.project = ?"),l.push(r)),o&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(L(o)));let N=m.length>0?`AND ${m.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${c}
    `).all(...l);if(!a)return S;let T=new Map(S.map(f=>[f.id,f])),h=e.map(f=>T.get(f)).filter(f=>!!f);return n?h.slice(0,n):h}getTimelineAroundTimestamp(e,s=10,t=10,n,r){return this.getTimelineAroundObservation(null,e,s,t,n,r)}getTimelineAroundObservation(e,s,t=10,n=10,r,o){let a=o?L(o):void 0,d=(E,R,g=!1)=>{let A=[],x=[];return r&&(g?(A.push(`(${E}.project = ? OR ${E}.merged_into_project = ?)`),x.push(r,r)):(A.push(`${E}.project = ?`),x.push(r))),a&&(A.push(`COALESCE(NULLIF(${R}.platform_source, ''), '${p}') = ?`),x.push(a)),{clause:A.length>0?`AND ${A.join(" AND ")}`:"",params:x}},c=d("o","src",!0),u=d("ss","src",!0),l=d("s","s"),m,N;if(e!==null){let E=`
      ...
      `,R=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let g=this.db.prepare(E).all(e,...c.params,t+1),A=this.db.prepare(R).all(e,...c.params,n+1);if(g.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};m=g.length>0?g[g.length-1].created_at_epoch:s,N=A.length>0?A[A.length-1].created_at_epoch:s}catch(g){return g instanceof Error?_.error("DB","Error getting boundary observations",{project:r},g):_.error("DB","Error getting boundary observations with non-Error",{},new Error(String(g))),{observations:[],sessions:[],prompts:[]}}}else{let E=`
      ...
      `,R=`
        ...
        LIMIT ?
      `;try{let g=this.db.prepare(E).all(s,...c.params,t),A=this.db.prepare(R).all(s,...c.params,n+1);if(g.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};m=g.length>0?g[g.length-1].created_at_epoch:s,N=A.length>0?A[A.length-1].created_at_epoch:s}catch(g){return g instanceof Error?_.error("DB","Error getting boundary timestamps",{project:r},g):_.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(g))),{observations:[],sessions:[],prompts:[]}}}let O=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
