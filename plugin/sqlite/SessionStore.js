...
"use strict";var $=Object.defineProperty;var Te=Object.getOwnPropertyDescriptor;var be=Object.getOwnPropertyNames;var ge=Object.prototype.hasOwnProperty;var fe=(i,e)=>{for(var t in e)$(i,t,{get:e[t],enumerable:!0})},Se=(i,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of be(e))!ge.call(i,n)&&n!==t&&$(i,n,{get:()=>e[n],enumerable:!(s=Te(e,n))||s.enumerable});return i};var Ne=i=>Se($({},"__esModule",{value:!0}),i);var We={};fe(We,{SessionStore:()=>Z});module.exports=Ne(We);var z=require("bun:sqlite"),Ee=require("crypto");var T=require("path"),M=require("os"),U=require("fs"),se=require("url");var he=null;function Re(i){return(he??process.stderr.write.bind(process.stderr))(i)}function k(i){Re(i)}var Ke=process.platform==="win32";function Ie(i){return i.replace(/^\uFEFF/,"")}function X(i){return JSON.parse(Ie(i))}function Oe(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,se.fileURLToPath)(__IMPORT_META_URL__))}var Ze=Oe();function ee(i){return typeof i!="string"||i.length===0?i:i==="~"?(0,M.homedir)():i.startsWith("~/")?(0,T.join)((0,M.homedir)(),i.slice(2)):i}function Ae(){if(process.env.CLAUDE_MEM_DATA_DIR)return ee(process.env.CLAUDE_MEM_DATA_DIR);let i=(0,T.join)((0,M.homedir)(),".claude-mem"),e=(0,T.join)(i,"settings.json");try{if((0,U.existsSync)(e)){let t=X((0,U.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return ee(s.CLAUDE_MEM_DATA_DIR)}}catch{}return i}var I=Ae(),Le=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,M.homedir)(),".claude"),es=(0,T.join)(Le,"plugins","marketplaces","thedotmack"),ye=(0,T.join)(I,"logs"),ss=(0,T.join)(I,"settings.json"),te=(0,T.join)(I,"claude-mem.db"),ve=(0,T.join)(I,"observer-sessions"),j=(0,T.basename)(ve);function ne(i){(0,U.mkdirSync)(i,{recursive:!0})}var H={dataDir:()=>I,workerPid:()=>(0,T.join)(I,"worker.pid"),serverPid:()=>(0,T.join)(I,".server-beta.pid"),serverPort:()=>(0,T.join)(I,".server-beta.port"),serverRuntime:()=>(0,T.join)(I,".server-beta.runtime.json"),settings:()=>(0,T.join)(I,"settings.json"),database:()=>(0,T.join)(I,"claude-mem.db"),chroma:()=>(0,T.join)(I,"chroma"),combinedCerts:()=>(0,T.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(I,"transcript-watch-state.json"),corpora:()=>(0,T.join)(I,"corpora"),supervisorRegistry:()=>(0,T.join)(I,"supervisor.json"),envFile:()=>(0,T.join)(I,".env"),logsDir:()=>ye};var v=require("fs"),Y=require("path");var q=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(q||{}),Ce=/^claude-mem-(\d{4}-\d{2}-\d{2})\.log$/,De=14,Ue=1440*60*1e3;function we(i,e=Date.now(),t=De){if(!(0,v.existsSync)(i))return 0;let s=new Date(e-t*Ue).toISOString().slice(0,10),n=0;try{for(let r of(0,v.readdirSync)(i)){let o=Ce.exec(r);if(!(!o||o[1]>=s))try{(0,v.unlinkSync)((0,Y.join)(i,r)),n+=1}catch{}}}catch{return n}return n}var W=null,V=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;logFileDate=null;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){let e=new Date().toISOString().split("T")[0];if(!(this.logFileInitialized&&this.logFileDate===e))try{let t=H.logsDir();(0,v.existsSync)(t)||(0,v.mkdirSync)(t,{recursive:!0}),we(t),this.logFilePath=(0,Y.join)(t,`claude-mem-${e}.log`),this.logFileInitialized=!0,this.logFileDate=e}catch(t){console.error("[LOGGER] Failed to initialize log file:",t instanceof Error?t.message:String(t)),this.logFilePath=null,this.logFileInitialized=!0,this.logFileDate=e}}getLevel(){if(this.level===null)try{let e=H.settings();if((0,v.existsSync)(e)){let t=(0,v.readFileSync)(e,"utf-8"),n=(X(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=q[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),r=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${r}:${o}:${a}.${d}`}log(e,t,s,n,r){if(e<this.getLevel())return;this.ensureLogFileInitialized();let o=this.formatTimestamp(new Date),a=q[e].padEnd(5),d=t.padEnd(6),c="";n?.correlationId?c=`[${n.correlationId}] `:n?.sessionId&&(c=`[session-${n.sessionId}] `);let u="";if(r!=null)if(r instanceof Error)u=this.getLevel()===0?`
${r.message}
${r.stack}`:` ${r.message}`;else if(this.getLevel()===0&&typeof r=="object")try{u=`
`+JSON.stringify(r,null,2)}catch{u=" "+this.formatData(r)}else u=" "+this.formatData(r);let l="";if(n){let{sessionId:N,memorySessionId:O,correlationId:S,...b}=n;Object.keys(b).length>0&&(l=` {${Object.entries(b).map(([g,C])=>`${g}=${C}`).join(", ")}}`)}let m=`[${o}] [${a}] [${d}] ${c}${s}${l}${u}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,m+`
`,"utf8")}catch(N){let O=N instanceof Error?N:new Error(String(N));k(`[LOGGER] Failed to write to log file: ${O.message}
${O.stack??""}
`)}else k(m+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){W=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!W||!(s instanceof Error))return;W(s)}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},_=new V;var re=require("crypto");function oe(i,e,t){return(0,re.createHash)("sha256").update([i||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function Me(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function L(i){if(!i)return p;let e=Me(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e.includes("grok")?"grok":e:p}function ie(i){let e=["claude","codex","grok","cursor"];return[...i].sort((t,s)=>{let n=e.indexOf(t),r=e.indexOf(s);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:t.localeCompare(s)})}function ae(i,e,t,s,n){let r=Date.now()-s,o=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return i.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get()!=null}function w(i,e,t){try{i.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw _.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function pe(i,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;w(i,`PRAGMA busy_timeout = ${Xe}`,"busy_timeout"),w(i,"PRAGMA foreign_keys = ON","foreign_keys"),w(i,"PRAGMA synchronous = NORMAL","synchronous"),w(i,`PRAGMA journal_size_limit = ${Pe}`,"journal_size_limit"),s&&!Be(i)&&w(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&w(i,"PRAGMA journal_mode = WAL","journal_mode")}var le=4096;var Ge=new Set(["set_title","set_prompt_session","remap_project"]),$e=/^(?:0|[1-9][0-9]*)$/,me=18446744073709551615n;function y(i){throw _.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function G(i,e={}){return typeof i!="string"||!$e.test(i)?y("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>me&&y("decimal value exceeds uint64"),e.positive&&i==="0"&&y("decimal value must be positive"),i)}function J(i){let e=G(i);return BigInt(e)===me&&y("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function je(i){(i===null||typeof i!="object"||Array.isArray(i))&&y("mutation must be an object");let e=i;if((typeof e.op!="string"||!Ge.has(e.op))&&y("unsupported mutation op"),e.op==="set_title"){let r=x(e,["fields","op","target"],"set_title"),o=B(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&y("set_title target requires a session identifier");for(let d of["memory_session_id","content_session_id","platform_source"])o[d]!==void 0&&D(o[d],d);let a=x(r.fields,["custom_title"],"set_title.fields");D(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=x(e,["fields","op","target"],"set_prompt_session"),o=x(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");He(o.origin_device_id),G(o.origin_local_id);let a=B(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");D(a.memory_session_id,"memory_session_id");for(let d of["content_session_id","platform_source","project"])a[d]!==void 0&&D(a[d],d);return}let t=x(e,["fields","op","where"],"remap_project"),s=B(t.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");s.project!==void 0&&D(s.project,"project"),s.memory_session_id!==void 0&&D(s.memory_session_id,"memory_session_id"),s.merged_into_project_is_null!==void 0&&s.merged_into_project_is_null!==!0&&y("merged_into_project_is_null may only be true"),Object.keys(s).length===0&&y("remap_project where is empty");let n=B(t.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&D(n.project,"project"),n.merged_into_project!==void 0&&D(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&y("remap_project fields are empty")}function Q(i){je(i)}function He(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?y("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function D(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>le?y(`${e} must be a non-blank string of at most ${le} UTF-8 bytes`):i}function x(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return y(`${t} must be an object`);let s=i,n=Object.keys(s).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&y(`${t} must contain exactly: ${r.join(", ")}`),s}function B(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return y(`${t} must be an object`);let s=i,n=new Set(e),r=Object.keys(s).find(o=>!n.has(o));return r&&y(`${t} contains unknown field ${r}`),s}var Z=class{db;constructor(e=te){e instanceof z.Database?this.db=e:(e!==":memory:"&&ne(I),this.db=new z.Database(e)),pe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let r=this.getIndexColumns(n.name);return r.length===t.length&&r.every((o,a)=>o===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?L(s):void 0;return n?this.db.prepare(`
    ...
    `);let s=this.db.prepare("SELECT version, applied_at FROM schema_versions WHERE version = ?").get(47);if(!s){let a=Date.now();this.db.transaction(()=>{this.db.run("DELETE FROM sync_launch_exclusions");for(let{table:u,kind:l}of e)this.db.prepare(`
          ...
          `).run(a);this.db.run("DELETE FROM sync_outbox"),this.db.run("DELETE FROM sync_content_outbox"),this.db.run("DELETE FROM sync_dead_letter"),this.db.run("DELETE FROM sync_state");let c=new Date(a).toISOString();this.db.prepare("INSERT INTO schema_versions (version, applied_at) VALUES (?, ?)").run(47,c),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(48,c)})();return}if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(48)&&t)return;let r=Date.parse(s.applied_at);if(!Number.isSafeInteger(r)||r<0)throw new Error(`schema v48: invalid v47 applied_at ${s.applied_at}`);this.db.transaction(()=>{for(let{table:a,kind:d}of e)this.db.prepare(`
    ...
    `).get(e,L(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o,type:a,concepts:d,files:c}=t,u=s==="relevance",l=u?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,m=n&&!u?`LIMIT ${n}`:"",N=e.map(()=>"?").join(","),O=[...e],S=[];if(r&&(S.push("(o.project = ? OR o.merged_into_project = ?)"),O.push(r,r)),o&&(S.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),O.push(L(o))),a)if(Array.isArray(a)){let R=a.map(()=>"?").join(",");S.push(`o.type IN (${R})`),O.push(...a)}else S.push("o.type = ?"),O.push(a);if(d){let R=Array.isArray(d)?d:[d],f=R.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");O.push(...R),S.push(`(${f.join(" OR ")})`)}if(c){let R=Array.isArray(c)?c:[c],f=R.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");R.forEach(A=>{O.push(`%${A}%`,`%${A}%`)}),S.push(`(${f.join(" OR ")})`)}let b=S.length>0?`WHERE o.id IN (${N}) AND ${S.join(" AND ")}`:`WHERE o.id IN (${N})`,g=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${b}
    ...
    `).get(e).count}createSDKSession(e,t,s,n,r){let o=new Date,a=o.getTime(),d=r?L(r):p,c=P(s);n&&this.validateSetTitleMutation(e,d,n);let u=this.db.prepare(`
    ...
    `).get(p,d,e);if(u){if(t&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,d,c,n||null,o.toISOString(),a);return n&&this.enqueueSetTitleOp(e,d,n),Number(l.lastInsertRowid)}enqueueSetTitleOp(e,t,s){let n=this.validateSetTitleMutation(e,t,s);this.enqueueMutationOp("1",n)}validateSetTitleMutation(e,t,s){let n={op:"set_title",target:{content_session_id:e,platform_source:t},fields:{custom_title:s}};return Q(n),n}saveUserPrompt(e,t,s,n){let r=new Date,o=r.getTime(),a=P(s),d=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,r=0,o,a){let d=this.storeObservations(e,t,[s],null,n,r,o,a);return{id:d.observationIds[0],createdAtEpoch:d.createdAtEpoch}}storeSummary(e,t,s,n,r=0,o){let a=o??Date.now(),d=new Date(a).toISOString();return{id:this.upsertSummaryRow(e,t,s,n,r,d,a),createdAtEpoch:a}}upsertSummaryRow(e,t,s,n,r,o,a){let d=n!==void 0?this.db.prepare(`
        ...
        UPDATE session_summaries SET
          ...
          created_at = ?, created_at_epoch = ?
        WHERE id = ?
      `).run(t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n??null,r,o,a,d.id),d.id;let c=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n??null,r,o,a);return Number(c.lastInsertRowid)}storeObservations(e,t,s,n,r,o=0,a,d){let c=a??Date.now(),u=new Date(c).toISOString();return this.db.transaction(()=>{let m=[],N=this.db.prepare(`
        ...
        RETURNING id
      `),O=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let b of s){let h=oe(e,b.title,b.narrative),g=N.get(e,t,b.type,b.title,b.subtitle,JSON.stringify(b.facts),b.narrative,JSON.stringify(b.concepts),JSON.stringify(b.files_read),JSON.stringify(b.files_modified),r||null,o,b.agent_type??null,b.agent_id??null,h,u,c,d||null,b.metadata??null);if(g){m.push(g.id);continue}let C=O.get(e,h);if(!C)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${h}`);m.push(C.id)}let S=null;return n&&(S=this.upsertSummaryRow(e,t,n,r,o,u,c)),{observationIds:m,summaryId:S,createdAtEpoch:c}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o}=t,a=s==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],m=[];r&&(m.push("(ss.project = ? OR ss.merged_into_project = ?)"),l.push(r,r)),o&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(L(o)));let N=m.length>0?`AND ${m.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT ss.*
      ...
      ${d}
      ${c}
    `).all(...l);if(!a)return S;let b=new Map(S.map(g=>[g.id,g])),h=e.map(g=>b.get(g)).filter(g=>!!g);return n?h.slice(0,n):h}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],m=[];r&&(m.push("s.project = ?"),l.push(r)),o&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(L(o)));let N=m.length>0?`AND ${m.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${c}
    `).all(...l);if(!a)return S;let b=new Map(S.map(g=>[g.id,g])),h=e.map(g=>b.get(g)).filter(g=>!!g);return n?h.slice(0,n):h}getTimelineAroundTimestamp(e,t=10,s=10,n,r){return this.getTimelineAroundObservation(null,e,t,s,n,r)}getTimelineAroundObservation(e,t,s=10,n=10,r,o){let a=o?L(o):void 0,d=(E,R,f=!1)=>{let A=[],F=[];return r&&(f?(A.push(`(${E}.project = ? OR ${E}.merged_into_project = ?)`),F.push(r,r)):(A.push(`${E}.project = ?`),F.push(r))),a&&(A.push(`COALESCE(NULLIF(${R}.platform_source, ''), '${p}') = ?`),F.push(a)),{clause:A.length>0?`AND ${A.join(" AND ")}`:"",params:F}},c=d("o","src",!0),u=d("ss","src",!0),l=d("s","s"),m,N;if(e!==null){let E=`
      ...
      `,R=`
        ...
        LIMIT ?
      `;try{let f=this.db.prepare(E).all(t,...c.params,s),A=this.db.prepare(R).all(t,...c.params,n+1);if(f.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};m=f.length>0?f[f.length-1].created_at_epoch:t,N=A.length>0?A[A.length-1].created_at_epoch:t}catch(f){return f instanceof Error?_.error("DB","Error getting boundary timestamps",{project:r},f):_.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(f))),{observations:[],sessions:[],prompts:[]}}}let O=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
