...
describe('SessionRoutes Codex provider', () => {
  it('uses Codex without automatically falling back to Claude', async () => {
    ...
    expect(starts).toEqual({ claude: 0, gemini: 0, openrouter: 0, codex: 1, grok: 0 });
  });
});
