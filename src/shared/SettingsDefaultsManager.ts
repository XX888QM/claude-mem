...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    // Opt-in only. Official ships pilot agent UUIDs; this fork keeps the allowlist empty.
    CLAUDE_MEM_GROK_BOT_AWARENESS_AGENT_IDS: '',
    ...
    // This fork does not import upstream's personal CCS Align seat.
